...
namespace MonoGame_Core.Scripts
{
    ...
    public static class CameraManager
    {
        ...
        public static void Initilize()
        {
            ...
            cameras.Add(new Camera("MainCamera", -1, 0, RenderingManager.WIDTH, RenderingManager.HEIGHT, new Vector2(RenderingManager.WIDTH, RenderingManager.HEIGHT), new Vector2(RenderingManager.WIDTH, RenderingManager.HEIGHT) * -1, new Vector2(RenderingManager.WIDTH, RenderingManager.HEIGHT)));
