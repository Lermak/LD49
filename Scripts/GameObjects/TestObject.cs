...
namespace MonoGame_Core.Scripts
{
    ...
    {
        public TestObject(SceneManager sm, List<Camera> cam, string texID, string tag) : base(sm, cam, texID, tag, new Vector2(40,40), new Vector2(0,0), 1)
        {
            ...
            ComponentHandler.AddComponent(new FontRenderer(this, new List<Camera>() { sceneManager.Cameras[0] }, "Test", "TestFont", Transform, new Vector2(0, 100), new Vector2(1920,1080),1,Color.Red));
