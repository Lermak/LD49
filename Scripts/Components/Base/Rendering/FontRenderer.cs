...
namespace MonoGame_Core.Scripts
{
    public class FontRenderer : SpriteRenderer
    {
        ...
        public FontRenderer(GameObject go, string text, string texID, Transform t, Vector2 off, Vector2 drawArea, int orderInLayer, Color clr, int uo) : base(go, texID, t, off, drawArea, orderInLayer, clr, uo)
        {
            name = "fontRenderer";
            this.text = text;
        }
